...
from monitorch.lens import OutputGradientGeometry
...
def test_output_gradient_geometry(module, loss_fn, visualizer, lens_kwargs):
    ...
    inspector = PyTorchInspector(lenses=[OutputGradientGeometry(**lens_kwargs)], module=module, visualizer=visualizer)
