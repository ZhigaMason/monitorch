...
class ParameterCond(AbstractLens):
    ...
    def __init__(
        self,
        inplace: bool = True,
        parameters: Iterable[str] = ('weight'),
    ):
        self._parameters = list(parameters)
        self._preprocessor = ParameterCondPreprocessor(self._parameters, inplace=inplace)
    ...
    def vizualize(self, vizualizer: AbstractVisualizer, epoch: int):
        ...
        """
        for parameter_name in self._parameters:
            vizualizer.plot_numerical_values(epoch, f'{parameter_name} Cond'.title(), self._data[parameter_name], None)
